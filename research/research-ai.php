...
<body>
<h1>Research AI PDF Ingest</h1>
<form method="POST" enctype="multipart/form-data">
    <div><label>PDF File: <input type="file" name="pdf" accept="application/pdf" required></label></div>
    <div><label>Title: <input type="text" name="title" required></label></div>
    <div><label>Author: <input type="text" name="author"></label></div>
    <div><label>Year: <input type="number" name="year"></label></div>
    <div><label>Page Offset: <input type="number" name="page_offset" value="0"></label></div>
