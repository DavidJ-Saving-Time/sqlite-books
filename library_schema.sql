...
, display_offset INTEGER DEFAULT 0, library_book_id INTEGER);
...
CREATE TABLE chunks (
  ...
  token_count INTEGER, display_start INTEGER, display_end   INTEGER, display_start_label TEXT, display_end_label TEXT,
...
CREATE TRIGGER chunks_ai AFTER INSERT ON chunks BEGIN
  INSERT INTO chunks_fts(rowid, text, item_id, pages)
  VALUES (
    new.id,
    new.text,
    new.item_id,
...
CREATE VIRTUAL TABLE chunks_fts USING fts5(
  id UNINDEXED,          -- keep your chunk id for convenience
  item_id UNINDEXED,     -- book id
  pages UNINDEXED,       -- computed label like "10–12" or "10"
