...
try {
    ...
    // --------------------------------------------------
    // Insert into custom_columns (multi column)
    // --------------------------------------------------
    $sqlInsert = "
        INSERT INTO custom_columns(label, name, datatype, is_multiple, editable, display, normalized)
        VALUES (:label, :name, 'text', True, True,
                '{\"is_names\": false, \"description\": \"\", \"web_search_template\": \"\"}',
                True);
    ";
    ...
    echo "Multi-value custom column '{$columnName}' (label: '{$columnLabel}') added as {$customTable}.\n";
