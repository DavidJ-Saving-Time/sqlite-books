...
// Handle edits when the form is submitted
...
<div class="container my-4">
    ...
    <h2 class="mt-4">Edit Metadata</h2>
    ...
    <form method="post" enctype="multipart/form-data" class="mb-4">
        ...
        <div class="mb-3">
            ...
            <textarea id="description" name="description" class="form-control" rows="8"><?= htmlspecialchars($comment) ?></textarea>
        </div>
        <div class="mb-3">
    ...
    if (img) {
        if (img.complete) {
            ...
            img.addEventListener('error', () => {
                if (dimLabel) dimLabel.textContent = 'Image not found';
            });
        }
    }
});
